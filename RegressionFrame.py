...
class Regression(tk.Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.label_parameter = tk.Label(self.parameter_frame)
        ...
        y_label = Label(self.label_predictors,text='ㄚ=')
        y_label.place(rely=0.9,relx=0)
    ...
    def train_button(self):
        ...
        self.best_model.laad_model_regression()
